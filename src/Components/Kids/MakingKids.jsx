    ...
    <div className="py-lg-5 py-md-4 py-sm-3 py-2 bg-common_clr_blue">
      <Container className="py-5">
        <Row className=" align-items-center text-center text-md-start">
          <Col lg={6}>
            <h2 className=" ff_Poppins fw-bold fs_62 text-white lh_140 mb-0 max_w_596">
              Making Kids Fall in Love with Math!
            </h2>
            <p className=" ff_Poppins fw-semibold mt-2 fs_16 lh_151 text-white mb-0">
            ...
            <button className="book_free_btn w-100 ff_Poppins fw-semibold fs_18 lh_151 text-white d-flex justify-content-center text-center mt-5">
