        ...
        <Row className=" d-flex justify-content-center justify-content-xl-start align-items-center align-items-xl-start">
          <Col md={6} lg={4} className="mt-3 mt-lg-0">
            <div className="common_card">
              ...
              <h2 className="ff_Jakarta fw-semibold fs_32 text-white lh_125 mt-3 mb-0">
                READ ONE OF JASON’S LATEST BOOKS
              </h2>
              <p className="ff_Poppins fw-medium fs_20 lh_132 text_clr_light_grey mb-1">
                Jason is an accomplished author whose books have captivated
                readers with their depth and insight. Drawing from his own life
                experiences, Jason weaves stories of leadership, business,
                healthcare and faith into actionable learnings that resonate
                with most.
              </p>
              <button className="common_bttn ff_Jakarta fw-semibold fs_20 lh_175 text-white mt-md-2">
                Get your copy >
              </button>
            </div>
          </Col>
