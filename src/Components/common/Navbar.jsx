    ...
    return (
        <nav className="z-3 py-md-4 py-3">
            ...
            <div className="d-flex align-items-center w-100  justify-content-between">
                ...
                {/* Navigation Links */}
                <ul
                    className={`d-flex flex-lg-row flex-column align-items-center mb-0 p-0 ${isOpen ? "open" : ""
                        } gap-3 gap-lg-5 `} >
                    ...
                    <li className=' list-unstyled'>
                        <button className="common_bttn text-white ff_Poppins fw-normal fs_16"  onClick={toggleMenu}>
                            Let’s connect
                        </button>
                    </li>
                </ul>
