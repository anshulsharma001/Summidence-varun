            ...
            <div className='custom_container container'>
                <div className="row align-items-center">
                    <div className="col-lg-6 col-12">
                        <p className='fs_24 lh_140 fw-normal ff_Jakarta text-white mb-0'>Do  you  need  any  help</p>
                        <h2 className=' ff_Poppins fs_56 lh_151 fw-semibold text-white mb-0' >A better learning Journey Future Start Here</h2>
                    ...
                    <div className='col-lg-6 col-12 mt-sm-5 mt-4 mt-lg-0'>
                        <div className='max_w_590 mx-auto mx-lg-0 d-flex align-items-center gap_do_you_image position-relative'>
                            <div className='image_box position-absolute'>
                                ...
                                <p className=" ff_Poppins fw-normal fs_18 lh_151 text-black text-center mt-sm-2 mt-1">Total students</p>
                                <button className=" ff_Poppins fw-normal fs_14 lh_140 text-white get_started_button border-0">Get started</button>
                            </div>
